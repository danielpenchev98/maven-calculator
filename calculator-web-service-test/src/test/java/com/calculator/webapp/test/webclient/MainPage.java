...
public class MainPage {
    ...
    private static final String CALCULATOR_SERVICE_WAR = "/calculator";
    private static final String GET_REQUEST_URL = "/api/v1/calculator/calculate";
    ...
    private URL getEncodedUrl(final String unformattedInput) throws IOException {
        ...
        return new URL(baseUrl,CALCULATOR_SERVICE_WAR + GET_REQUEST_URL +"?"+REQUEST_PARAMETER+"="+encodedEquation);
    }
}
